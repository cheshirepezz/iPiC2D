...
def avg1(A):
    ...
    '''
    res = np.zeros_like(A)
    res[ib:ie, jb:je] = (A[ib+1:ie+1, jb:je] + A[ib:ie, jb:je])/2
    return res
...
def avg2(A):
    ...
    '''
    res = np.zeros_like(A)
    res[ib:ie, jb:je] = (A[ib:ie, jb+1:je+1] + A[ib:ie, jb:je])/2
    return res
...
def curl(A1, A2, A3, s):
    ...
    curlx1 = ((derx2(avg1(g31[:, :, s] * A1), s) + derx2(avg2(g32[:, :, s] * A2), s) + derx2(g33[:, :, s] * A3, s)))/J
    curlx2 = - (derx1(avg1(g31[:, :, s] * A1), s) + derx1(avg2(g32[:, :, s] * A2), s) + derx1(g33[:, :, s] * A3, s))/J
    curlx3 = ((derx1(avg1(avg2(g21[:, :, s] * A1)), s) + derx1(g22[:, :, s] * A2, s) + derx1(avg2(g23[:, :, s] * A3), s))\
           -  (derx2(g11[:, :, s] * A1, s) + derx2(avg2(avg1(g12[:, :, s] * A2)), s) + derx2(avg1(g13[:, :, s] * A3), s)))/J
...
#g11[:, :, 1] = avg1(avg2(g11[:, :, 1]))
#g12[:, :, 1] = avg1(avg2(g12[:, :, 1]))
#g13[:, :, 1] = avg1(avg2(g13[:, :, 1]))
#g21[:, :, 1] = avg1(avg2(g21[:, :, 1]))
#g22[:, :, 1] = avg1(avg2(g22[:, :, 1]))
#g23[:, :, 1] = avg1(avg2(g23[:, :, 1]))
#g31[:, :, 1] = avg1(avg2(g31[:, :, 1]))
#g32[:, :, 1] = avg1(avg2(g32[:, :, 1]))
#g33[:, :, 1] = avg1(avg2(g33[:, :, 1]))
